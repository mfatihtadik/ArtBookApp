...
class ArtFragment @Inject constructor(val artRecyclerAdapter: ArtRecyclerAdapter) : Fragment(R.layout.fragment_arts) {
    ...
    //lateinit var vievModel : ArtViewModel

    private val vievModel: ArtViewModel by viewModels()
    ...
    private val swipeCallBack = object : ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
        ...
        override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
            ...
            vievModel.deleteArt(selectedArt)
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //vievModel = ViewModelProvider(requireActivity()).get(ArtViewModel::class.java)
        //vievModel = ViewModelProvider(requireActivity())[ArtViewModel::class.java]
    ...
    private fun subscribeToObservers() {
        vievModel.artList.observe(viewLifecycleOwner, Observer {
